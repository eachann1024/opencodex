...
export const ja: Record<TKey, string> = {
  ...
  "cws.field.defaultEffortHint": "クライアントが推論負荷を省略した場合のみ使用されます。選択肢は負荷ラダーを公開しているターゲットが広告する負荷の交差です。カタログに負荷メタデータがないターゲットはリストを制限しません。",
  ...
  "cws.field.defaultEffortUnknownMarker": "未知ターゲットあり",
  "cws.field.defaultEffortUnknown": "一部のターゲットにカタログ負荷ラダーがありません。選択肢は選べますが、未知ターゲットではランタイムがデフォルトを省略します（フェイルクローズ）。",
  "cws.capabilities": "能力",
