...
export const zh: Record<TKey, string> = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.field.defaultEffortHint": "仅在客户端未指定推理级别时使用。选项为已公布努力阶梯的目标所声明级别的交集；没有目录努力元数据的目标不会限制列表。",
  "cws.field.defaultEffortUnsupported": "该级别不在目标的公共阶梯中 — 请求时会被忽略或就近映射。",
  "cws.field.defaultEffortUnsupportedOption": "不在交集中",
  "cws.field.defaultEffortUnknownMarker": "含未知目标",
  "cws.field.defaultEffortUnknown": "部分目标没有目录努力阶梯。列表仍可选，但运行时对这些未知目标会省略默认值（失败关闭）。",
  "cws.capabilities": "能力",
