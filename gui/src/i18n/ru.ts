...
export const ru: Record<TKey, string> = {
  ...
  "cws.field.defaultEffortHint": "Используется, только если клиент не указал уровень рассуждений. Варианты — пересечение заявленных уровней целей, публикующих шкалу; цели без метаданных усилий в каталоге список не ограничивают.",
  ...
  "cws.field.defaultEffortUnknownMarker": "неизвестные цели",
  "cws.field.defaultEffortUnknown": "У части целей нет лестницы усилий в каталоге. Варианты остаются доступны, но для неизвестных целей runtime не подставляет значение по умолчанию (fail closed).",
