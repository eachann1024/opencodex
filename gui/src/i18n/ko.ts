...
export const ko: Record<TKey, string> = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.field.defaultEffortHint": "클라이언트가 추론 수준을 생략한 경우에만 사용합니다. 옵션은 노력 사다리를 공개하는 대상이 광고하는 수준의 교집합입니다. 카탈로그 노력 메타데이터가 없는 대상은 목록을 제한하지 않습니다.",
  ...
  "cws.field.defaultEffortUnknownMarker": "알 수 없는 대상",
  "cws.field.defaultEffortUnknown": "일부 대상에 카탈로그 노력 사다리가 없습니다. 옵션은 선택 가능하지만, 런타임은 알 수 없는 대상에 대해 기본값을 생략합니다(실패 시 닫힘).",
  "cws.capabilities": "기능",
