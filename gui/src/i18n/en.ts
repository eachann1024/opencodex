...
export const en = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.field.defaultEffortHint": "Used only when the client omits reasoning effort. Options are the intersection of advertised efforts from targets that publish a ladder; targets without catalog effort metadata do not restrict the list.",
  ...
  "cws.field.defaultEffortUnknownMarker": "unknown targets",
  "cws.field.defaultEffortUnknown": "Some targets have no catalog effort ladder. Options stay selectable, but runtime omits the default for those unknown targets (fails closed).",
