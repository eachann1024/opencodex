...
export const de: Record<TKey, string> = {
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "cws.field.defaultEffortHint": "Nur verwendet, wenn der Client keinen Reasoning-Aufwand sendet. Optionen sind die Schnittmenge der beworbenen Aufwände von Zielen, die eine Leiter veröffentlichen; Ziele ohne Katalog-Aufwandsmetadaten schränken die Liste nicht ein.",
  ...
  "cws.field.defaultEffortUnknownMarker": "unbekannte Ziele",
  "cws.field.defaultEffortUnknown": "Einige Ziele haben keine Katalog-Aufwandsleiter. Optionen bleiben wählbar, aber die Laufzeit lässt den Standard für unbekannte Ziele weg (fail closed).",
